  ...
  return (
    <div className="min-h-screen flex bg-canvas">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative bg-[#010409]">
        ...
        />
        <div className="absolute bottom-16 left-12 z-20 max-w-lg pr-8">
           <h1 className="text-5xl font-black text-white mb-6 tracking-tighter leading-tight">Software engineering, <br/><span className="text-gh-blue">reimagined.</span></h1>
           <p className="text-lg text-gray-300 font-medium leading-relaxed opacity-90">Join the world's most advanced local-first Git platform. Build, collaborate, and scale with native performance.</p>
        </div>
      </div>
      ...
      <div className="w-full lg:w-1/2 flex flex-col justify-center px-8 md:px-24 xl:px-48 py-12">
        <div className="max-w-md w-full mx-auto">
          <div className="mb-10 text-center lg:text-left">
             ...
             <h2 className="text-3xl font-extrabold text-fg tracking-tight">Welcome back</h2>
             <p className="text-gh-gray mt-2 font-medium">Please sign in to your WaiCode account.</p>
          </div>

          <form className="space-y-5" onSubmit={handleSubmit}>
            <div className="space-y-4">
              <div>
                <label className="text-sm font-bold text-fg mb-1.5 block ml-1">Email or Username</label>
                <input
                  type="email"
                  required
            ...
            <div>
              <button
                type="submit"
                disabled={isLoading}
                className="w-full flex justify-center py-3 px-4 border border-transparent font-bold rounded-lg text-white bg-gh-blue hover:opacity-90 focus:outline-none transition-all shadow-lg shadow-gh-blue/20 disabled:bg-gray-400"
              >
            ...
            <div className="flex items-center justify-center space-x-2 text-sm mt-8">
               <span className="text-gh-gray">New to WaiCode?</span>
               <a href="/auth/signup" className="text-gh-blue font-bold hover:underline">
                 Create an account
               </a>
            </div>
          </form>
